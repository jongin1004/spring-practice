...
public class ValidationItemControllerV2 {
    ...
    /**
     * BindingResult는 @ModelAttribute에서 데이터가 잘 담기지 못했을 경우의 메세지가 담기게
     * 위치는, @ModelAttribute 다음에 파라미터로 받아야함
     *
     * @param item
     * @param bindingResult
...
//            errors.put("quantity", "수량은 최대 9,999개까지 허용합니다.");
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (totalPrice < 10000) {
//                errors.put("globalError", "가격 * 수량의 합은 10,000원 이상이어야 합니다. 현재값 = " + totalPrice);
                bindingResult.addError(new ObjectError("item", "가격 * 수량의 합은 10,000원 이상이어야 합니다. 현재값 = " + totalPrice));
            }
        }
